...
@Component({
  selector: 'app-addmemberform',
  templateUrl: './addmemberform.component.html',
  styleUrls: ['./addmemberform.component.css']
})
     ...
     var dateObj = new Date();
      ...
      if(this.nid===undefined||this.nid===false||this.nid===null){
       ...
       let res={
         ...
         this.firebaseService.createemployeemember(res).then(kam=>{
          if(kam.get.length!==0){
